...
const CreatePolygons = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            dispatch(fetchRouteLine(undefined, selectedProfile));
        }
    };
    ...
    const validateForm = () => {
        ...
        if (!validateName(formData.name)) {
            newErrors.name =
                'Name must be 3-30 characters long and contain only letters or numbers.';
        }
        ...
        if (
            ...
            !validateEffectValue(formData.effectValue, formData.type)
        ) {
    ...
    useEffect(() => {
        if (coordinates.length > 0) {
            ...
            dispatch(setCoordinates([])); // Reset coordinates after updating formData
        }
        ...
        <div className="create-polygons">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button
                    type="submit"
                    disabled={!canClick()}
                    className={!canClick() ? 'btn-disabled' : ''}
                >
                    Submit
                </button>
            </form>
