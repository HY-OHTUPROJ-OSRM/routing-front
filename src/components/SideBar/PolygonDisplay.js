...
import { DeletePolygon } from '../../services/PolygonService';
import { fetchPolygons } from '../../features/polygons/polygonsLoader';
import { fetchRouteLine } from '../../features/routes/routeLoader';
import { getCentroid, zoomFit } from '../../features/polygons/IntersectSelf';
...
const PolygonDisplay = ({ type, geometry, properties, index }) => {
    ...
    return (
        <div
            className={highlightedId === properties.id ? 'highlight' : 'polygon'}
            id={properties.id}
        >
